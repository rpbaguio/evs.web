            ...
            <form id="create-form">
                <div class="modal-body px-5">
                    ...
                    <div class="form-group">
                        <label for="short-name">Short Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="short-name" name="short_name" value="<?= set_value('short_name') ?>" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="long-name">Long Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="long-name" name="long_name" value="<?= set_value('long_name') ?>" placeholder="">
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="update-form">
                <div class="modal-body px-5">
                    ...
                    <div class="form-group">
                        <label for="short-name">Short Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="short-name" name="short_name" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="long-name">Long Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="long-name" name="long_name" placeholder="">
                    </div>
                </div>
                <div class="modal-footer">
        ...
        let getAll = {
            ...
            displayTable: function() {
                let table = $('#datatables__default').DataTable({
                    ...
                    "responsive": true,
                    "ajax": {
                        "url": baseURL + "/admin/groups/groups",
                        "type": "GET"
                    },
                    "columns": [
                        {
        ...
        let getById = {
            ...
            displayForm: function() {
                $('#update').on('show.bs.modal', function (e) {
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/groups/group/?id=' + id,
                        type: 'GET',
                        dataType: 'json',
                    ...
                    jqXHR.done(function (data) {
                        if (data) {
                            ...
                            _this.find('input[name="short_name"]').val(data.short_name);
                            _this.find('input[name="long_name"]').val(data.long_name);
                        }
                    });
        ...
        let create = {
            ...
            autoFocus: function() {
                $('#create').on('shown.bs.modal', function(){
                    $(this).find('input[name="short_name"]').trigger('focus');
                });
            },
            bindForm: function () {
            ...
            submitForm: function() {
                ...
                $('#create-form').on('submit', function(e){
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/groups/create',
                        type: 'POST',
                        dataType: 'json',
                        data: _this.serialize(),
                        cache: false,
                    ...
                    jqXHR.done(function (data) {
                        if (data.status === true) {
                            ...
                            (Boolean(data.short_name)) ? _this.find('input[name="short_name"]').addClass('is-invalid') : _this.find('input[name="short_name"]').removeClass('is-invalid'); 
                            (Boolean(data.long_name)) ? _this.find('input[name="long_name"]').addClass('is-invalid') : _this.find('input[name="long_name"]').removeClass('is-invalid');  
                        }
                    });
        ...
        let update = {
            ...
            submitForm: function() {
                $('#update-form').on('submit', function(e){
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/groups/update/id/' + id,
                        type: 'PUT',
                        dataType: 'json',
                        data: _this.serialize(),
                        cache: false,
        ...
        let softDelete = {
            ...
            bindForm: function () {
                $('#delete').on('show.bs.modal', this.submitForm(), function(e){
                    ...
                    $(this).find('.modal-body p').text('Are you sure you want to delete this group?');
                });
            },
            submitForm: function() {
                $('#delete-form').on('submit', function(e){
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/groups/delete/id/' + id,
                        type: 'PUT',
                        dataType: 'json',
                        data: _this.serialize(),
                        cache: false,
