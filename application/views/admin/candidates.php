            ...
            <form id="update-form">
                <div class="modal-body px-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="form-group">
                                <label for="update-position">Position <span class="text-danger">*</span></label>
        ...
        let getAll = {
            ...
            displayTable: function() {
                let table = $('#datatables__default').DataTable({
                    ...
                    "responsive": true,
                    "ajax": {
                        "url": baseURL + "/admin/candidates/candidates",
                        "type": "GET"
                    },
                    "columns": [
                        {
        ...
        let getById = {
            ...
            displayForm: function() {
                $('#update').on('show.bs.modal', function (e) {
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/candidates/candidate/?id=' + id,
                        type: 'GET',
                        dataType: 'json',
        ...
        let create = {
            ...
            submitForm: function() {
                ...
                $('#create-form').on('submit', function(e){
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/candidates/create',
                        type: 'POST',
                        dataType: 'json',
                        data: _this.serialize(),
                        cache: false,
        ...
        let update = {
            ...
            submitForm: function() {
                $('#update-form').on('submit', function(e){
                    ...
                    let jqXHR = $.ajax({
                        url: baseURL + '/admin/candidates/update/id/' + id,
                        type: 'PUT',
                        dataType: 'json',
                        data: _this.serialize(),
                        cache: false,
                    ...
                    jqXHR.done(function (data) {
                        if (data.status === true) {
                            ...
                            (Boolean(data.position_id)) ? _this.find('span[aria-labelledby="select2-update-position-container"]').css({'border':'1px solid #d9534f'}) : _this.find('span[aria-labelledby="select2-position-group-container"]').removeAttr('style'); 
                        }  
                    });
        ...
        let softDelete = {
            ...
            bindForm: function () {
                $('#delete').on('show.bs.modal', this.submitForm(), function(e){
                    ...
                    $(this).find('.modal-body p').text('Are you sure you want to delete this candidate?');
                });
            },
            submitForm: function() {
